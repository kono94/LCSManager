...
class TwitchTV {
  ...
  var $client_id = 'j0afwr5oukli7ap3zmqxbrpm43pbonx'; //change this value, should be your TwitchTV Application Client ID
  var $client_secret = "ib67g2nahvoryr4q09n3vtr0gy8w5j5"; //change this value, should be your TwitchTV Application Client Secret 
  var $redirect_url = 'http://192.168.2.100:8083/scripts/twitch_login.php'; //change this value, should be your TwitchTV Application Rerdirect URL
  var $scope_array = array('user_read');
	 ...
	 * 
	 * @param string $access_token
	 * @return string 		EMAIL that is 
	 */
	function authenticated_channel_name($access_token) {
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, $this->base_url . "user");
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
...
/**
	 ...
	 * @return string 		EMAIL that is 
	 */
	function authenticated_user_email($access_token) {
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, $this->base_url . "user");
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array(
